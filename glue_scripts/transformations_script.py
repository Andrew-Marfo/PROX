...
schemas = {
    ...
    "payment_records": StructType([
        StructField("payment_record_id", IntegerType(), False),
        StructField("booking_id", IntegerType(), False),
    ...
    "quote_requests": StructType([
        ...
        StructField("description", StringType(), True),
        StructField("budget_range", StringType(), True),
    ...
    "quotes": StructType([
        ...
        StructField("quote_request_id", IntegerType(), True),
        StructField("provider_id", IntegerType(), True),
        StructField("amount", DecimalType(10, 2), True),
        StructField("details", StringType(), True),
        StructField("expire_date", TimestampType(), True),
